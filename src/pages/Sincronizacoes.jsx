...
const RECURSOS_CONFIG = {
  ...
  votacoes:     { label: 'Votações',      cor: '#d97706', fonte: 'parlamento.pt · Arquivo de Votações (por dia)',          url: 'https://www.parlamento.pt/ArquivoDocumentacao/Paginas/Arquivodevotacoes.aspx' },
